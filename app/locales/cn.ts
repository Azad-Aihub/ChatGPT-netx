...
const cn = {
  ...
  Store: {
    DefaultTopic: "新的聊天",
    BotHello: "加入Q群 340825795 或 前往公众号：AI创翼 关注回复“ 访问码 ”获取访问密码，然后点击左下角设置按钮输入密码后解锁免费使用。如果遇到卡顿或无响应？可能是用户量太大， 👉点左下角购物车获得个人独立账号 KEY 使用。已补充内置额度并更新版本，更新时间：2023.05.08 13:30",
    Error: "出错了，稍后重试吧",
    Prompt: {
